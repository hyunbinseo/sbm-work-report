...
<div class="bg-gray-50">
	<main class="mx-auto max-w-7xl px-4 py-10 sm:py-16 sm:px-6 lg:px-8">
		<div class="mx-auto max-w-2xl lg:max-w-none">
			<form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
				...
				<div class="mt-10 lg:mt-0">
					...
					<div
						class="mt-4 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm sm:sticky sm:top-6 lg:top-8"
					>
						<Report />
